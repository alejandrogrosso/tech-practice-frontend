    ...
    <div className="bg-[#f5f6fa] min-h-screen w-full">
      <div className="flex justify-center">
        <div className="w-full max-w-[1200px] flex flex-col gap-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start px-6">
            {/* Columna 1: Galería */}
            <div className="pt-2">
            ...
            {/* Columna 3: Sidebar */}
            <aside className="w-[320px] flex flex-col gap-4 md:sticky md:top-6 h-fit pt-2">
              {/* Caja principal */}
          ...
          {/* Grid para productos relacionados debajo del bloque principal */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start px-6">
