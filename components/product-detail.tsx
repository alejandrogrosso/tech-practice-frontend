    ...
    <div className="flex w-full min-h-screen bg-[#f5f6fa]">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="px-6 w-full max-w-[1200px] mx-auto">
          <div className="border-t border-gray-200 pt-2 pb-2 mt-4">
            <div className="mb-2">
            ...
            <div className="relative">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {[ // Ejemplo de productos relacionados
                  ...
                  <div
                    key={i}
                    className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col transition-all duration-200 p-4 h-full"
                  >
        ...
        <div className="px-6 w-full max-w-[1200px] mx-auto mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[ // Ejemplo de productos de la tienda
                ...
                <div key={i} className="relative">
                  <a
                    href={prod.link}
                    className="flex bg-white border border-gray-200 rounded-lg p-8 gap-6 items-center hover:shadow transition-shadow min-h-[160px] w-full"
                  >
                    <img
                      src={prod.img}
                      alt={prod.title}
          ...
          <a href="#" className="block text-[#3483fa] text-base font-semibold mt-4 hover:underline">Ver más productos de {product.brand}</a>
        </div>

        {/* Sección inferior: Características del producto y descripción */}
        <div className="flex flex-col gap-6 max-w-[1200px] mx-auto px-6 mt-8 mb-8">
