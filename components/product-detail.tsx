    ...
    <>
      ...
      <div className="flex w-full min-h-screen bg-white">
        ...
        <main className="flex-1 flex flex-col">
          ...
          {/* Productos relacionados horizontal, ocupa ambas columnas */}
          <div className="px-6 w-full max-w-[1200px] mx-auto">
            <div className="border-t border-gray-300 pt-2 pb-2 mt-4">
              <div className="mb-2">
              ...
              <div className="relative">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  {[ // Ejemplo de productos relacionados
                    ...
                    <div
                      key={i}
                      className="bg-white border border-gray-300 rounded-lg shadow-sm flex flex-col transition-all duration-200 p-4 h-full"
                    >
          ...
          {/* Productos de la tienda (ej: Productos de Samsung) */}
          <div className="px-6 w-full max-w-[1200px] mx-auto mt-8">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[ // Ejemplo de productos de la tienda
                  {
                    img: 'https://http2.mlstatic.com/D_Q_NP_2X_970857-MLA74721823432_022024-T.webp',
                    title: 'Samsung Galaxy S23 256 Gb Garantía Oficial',
                    price: '959',
                    old: '1.299',
                    off: '26% OFF',
                  ...
                  {
                    img: 'https://http2.mlstatic.com/D_Q_NP_2X_970857-MLA74721823432_022024-T.webp',
                    title: 'Samsung Galaxy S23 Plus 512 Gb Garantía Oficial',
                    price: '1.379',
                    old: '1.699',
                    off: '18% OFF',
                  ...
                  <div key={i} className="relative">
                    <a
                      href={prod.link}
                      className="flex bg-white border border-gray-300 rounded-lg p-8 gap-6 items-center hover:shadow-sm transition-shadow min-h-[160px] w-full"
                      style={{ marginRight: i === arr.length - 1 ? '0' : '24px' }}
                    >
                      <img
                        src={prod.img}
                        alt={prod.title}
                        width={120}
                        height={120}
                        className="object-contain rounded max-h-[120px] min-w-[120px] bg-white border"
                      />
                      <div className="flex-1 min-w-0">
                        <div className="text-lg font-semibold text-gray-900 leading-tight mb-1 truncate">{prod.title}</div>
                    ...
                    {/* Flecha visual solo en la segunda card en desktop */}
                    {i === arr.length - 1 && (
                      <button
          ...
          <div className="flex flex-col gap-6 max-w-[1200px] mx-auto px-6 mt-8 mb-8 border-t border-gray-300">
            {/* Características del producto */}
            <div className="bg-white border border-gray-300 rounded-lg p-0">
              ...
              <div className="px-5 py-5">
                ...
                <div className="mt-3">
                  <a href="#" className="text-blue-600 text-xs hover:underline">Ver todas las características</a>
                </div>
              </div>
            </div>
        ...
        {/* Sidebar sticky */}
        <aside className="w-[320px] flex flex-col gap-4 sticky top-0 h-screen">
          {/* Caja principal */}
          <div className="bg-white border border-gray-200 rounded-lg p-5 flex flex-col gap-4 shadow-sm">
            ...
            {/* Bloque de reputación de la tienda oficial */}
            <div className="bg-white border border-gray-200 rounded-lg p-0 flex flex-col shadow-sm overflow-hidden mb-2">
              {/* Banner negro y logo */}
